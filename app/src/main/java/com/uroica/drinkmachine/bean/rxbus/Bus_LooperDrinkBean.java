...
//            this.result_channel = Integer.valueOf(ss.substring(6, 8));
//            this.result_shipment = Integer.valueOf(ss.substring(5, 6));
////        this.result_channel = Integer.valueOf(data.substring(10, 11));
////        this.result_shipment = Integer.valueOf(data.substring(11, 12));
//            this.vibration_state = Integer.valueOf(data.substring(12, 14));
//            this.real_Temp = Integer.parseInt(data.substring(14, 16), 16);
//        }catch (Exception e){
//
//        }
//        ;
