...
public class CRC16Util {
     ...
     *
     * @param data   *            需要计算的数组
     * @param format *            是否高低位互换
     * @return CRC16校验值
     */
    public static int calcCrc16(byte[] data, boolean format) {
        return calcCrc16(data, 0, data.length, format);
    }
     ...
     * @return CRC16校验值
     */
    public static int calcCrc16(byte[] data, int offset, int len, boolean format) {
        return calcCrc16(data, offset, len, 0xffff, format);
    }
     ...
     * @return CRC16校验值
     */
    public static int calcCrc16(byte[] data, int offset, int len, int preval, boolean format) {
     ...
     * @return
     */
    public static byte[] calcCrc16ToBytes(byte[] data, boolean format){
        int crc16Result=calcCrc16(data,format);
       byte[] bytes= ChangeTool.intToBytes(crc16Result);
        byte[] resultByte=byteMerger(data,bytes);
        return resultByte;
    }
